...
uses
  ...
  aResult, mParam, uReadky, ufrmInformation,uWebagent,uUtilitise,
  ShellAPI,uTaskSchedule,uYahooMail,EASendMailObjLib_TLB,UTblCreate,CheckLst,GetKHAVersion;
...
begin
 HMainIcon:=LoadIcon(MainInstance, 'MAINICON');
  ...
  begin
    ...
    hIcon               := HMainIcon;
    szTip               := 'Semi Automatic Module'+#13#10+'Scraping Monitoring System';
  end;
